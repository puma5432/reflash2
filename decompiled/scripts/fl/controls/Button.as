package fl.controls
{
   ...
   public class Button extends LabelButton implements IFocusManagerComponent
   {
      ...
      protected function drawEmphasized() : void
      {
         ...
         var _loc2_:Object = getStyleValue("emphasizedSkin");
         if(_loc2_ != null)
         {
            this.emphasizedBorder = getDisplayObjectInstance(_loc2_);
         }
         if(this.emphasizedBorder != null)
         {
            addChildAt(this.emphasizedBorder,0);
            _loc1_ = Number(getStyleValue("emphasizedPadding"));
            this.emphasizedBorder.x = this.emphasizedBorder.y = -_loc1_;
            this.emphasizedBorder.width = width + _loc1_ * 2;
            this.emphasizedBorder.height = height + _loc1_ * 2;
         }
      }

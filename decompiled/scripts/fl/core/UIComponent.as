package fl.core
{
   ...
   public class UIComponent extends Sprite
   {
      ...
      public static function mergeStyles(... rest) : Object
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            for(_loc3_ in _loc2_)
            {
               ...
               {
                  _loc4_[_loc3_] = rest[_loc6_][_loc3_];
               }
            }
            _loc6_++;
         }
      ...
      private function removedHandler(param1:Event) : void
      {
         ...
         var _loc7_:IFocusManager = this.focusManager;
         if(_loc7_ != null)
         {
            _loc2_ = focusManagerUsers[_loc7_];
            if(_loc2_ != null)
            {
               delete _loc2_[this];
               _loc3_ = true;
               ...
               if(_loc3_)
               {
                  delete focusManagerUsers[_loc7_];
                  _loc2_ = null;
               }
            }
            if(_loc2_ == null)
            {
               _loc7_.deactivate();
               for(_loc5_ in focusManagers)
               {
                  _loc6_ = focusManagers[_loc5_];
                  if(_loc7_ == _loc6_)
                  {
                     delete focusManagers[_loc5_];
                  }
               }
            }
         }

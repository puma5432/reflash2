package com.mcleodgaming.ssf2
{
   ...
   public dynamic class Main extends MovieClip
   {
      ...
      private static function initGame() : void
      {
         ...
         // var unixTimestamp:uint = 0; //edit: deleted to disable discord extension
         try
         {
         ...
         // Discord Rich Presence disabled in the research build: the macOS
         // payload ships a stub DiscordANE with no native library, so the
         // SDK context is always null and would spam "No context to call!"
         // once per second. All call sites are null-guarded on Main.m_sdk.
         m_sdk = null;

         // try //edit: deleted to disable discord extension
         // {
